...
class MockData {
  static final List<StudyArea> studyAreas = [
    ...
    StudyArea(
      id: '9',
      title: 'Machine Learning Severity Classification',
      description: 'Advanced neural network model trained to predict oil spill severity using SAR backscatter signatures, environmental conditions, and AIS vessel proximity data. The confusion matrix reveals 89% accuracy across severity categories with minimal false positives.',
      category: 'Machine Learning',
      location: 'Chesapeake Bay Region',
      imageUrl: 'assets/charts/additional-charts/ConfusionMatrixOilSpillSeverityClassification.webp',
      lastUpdated: DateTime.now().subtract(const Duration(hours: 3)),
      metadata: {
        'model_accuracy': '89%',
        'training_samples': '12,500',
    ...
    StudyArea(
      ...
      description: 'Systematic analysis of environmental and SAR features contributing to oil spill severity prediction. VV polarization, wind speed, and ship proximity emerge as top predictive factors with combined importance exceeding 70%.',
      category: 'Machine Learning',
      location: 'Chesapeake Bay Region',
      imageUrl: 'assets/charts/additional-charts/FeatureImportanceInOilSpillSeverityPrediction.webp',
      lastUpdated: DateTime.now().subtract(const Duration(hours: 5)),
      metadata: {
        'top_feature': 'VV Polarization',
    ...
    StudyArea(
      id: '11',
      title: 'Predicted SAR Oil Spills Map',
      description: 'Comprehensive spatial prediction map showing probable oil spill locations across Chesapeake Bay using trained ML models. High-risk zones cluster along shipping lanes and port approaches with prediction confidence >85%.',
      category: 'Spatial Analysis',
      location: 'Chesapeake Bay',
      imageUrl: 'assets/charts/additional-charts/PredictedSAROilSpillsInChesapeakeBay.webp',
    ...
    StudyArea(
      id: '12',
      title: 'Baltimore-Chesapeake Oil Candidates',
      description: 'Focused prediction analysis for Baltimore harbor and northern Chesapeake region. Model identifies 847 potential oil candidates with 78% validation against ground truth observations.',
      category: 'Spatial Analysis',
      location: 'Baltimore-Chesapeake',
      imageUrl: 'assets/charts/additional-charts/PredictedOilSpillCandidatedInBaltimore-Chesapeake.webp',
      lastUpdated: DateTime.now().subtract(const Duration(hours: 7)),
      metadata: {
        'candidates_found': '847',
        'validation_rate': '78%',
    ...
    StudyArea(
      id: '13',
      title: 'Neural Network Severity Predictions',
      description: 'Deep learning model output visualization showing predicted oil spill severity classes across the bay. Network architecture employs convolutional layers for spatial feature extraction combined with temporal LSTM cells.',
      category: 'Machine Learning',
      location: 'Chesapeake Bay Region',
      imageUrl: 'assets/charts/additional-charts/PredictedOilSpillSeverityNeuralNetwork.webp',
    ...
    StudyArea(
      id: '14',
      title: 'Potential Oil Slicks Detection',
      description: 'High-resolution SAR-based identification of potential oil slick formations using VH/VV ratio thresholding and texture analysis. Automated detection pipeline processes 548 image dates revealing 3,214 slick candidates.',
      category: 'Oil Spills',
      location: 'Chesapeake Bay',
      imageUrl: 'assets/charts/additional-charts/PotentialOilSlicks.webp',
      lastUpdated: DateTime.now().subtract(const Duration(hours: 11)),
      metadata: {
        'slick_candidates': '3,214',
        'detection_method': 'VH/VV Ratio',
        'image_dates': '548',
    ...
    StudyArea(
      id: '15',
      title: '3D Spill Persistence Visualization',
      description: 'Interactive three-dimensional visualization of oil spill persistence patterns over time and space. Z-axis represents spill duration while XY plane shows geographic distribution, revealing long-term pollution hotspots.',
      category: 'Temporal Analysis',
      location: 'Chesapeake Bay Region',
      imageUrl: 'assets/charts/additional-charts/3DVisualizationOfOilSpillPersistenceOverTime.webp',
      lastUpdated: DateTime.now().subtract(const Duration(hours: 2)),
      metadata: {
        'max_persistence': '45 days',
        'hotspot_count': '8',
        'temporal_span': '9 years',
